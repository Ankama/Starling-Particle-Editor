...
package starling.extensions
{
    ...
    public class OpenPDParticleSystem extends ParticleSystem
    {
        ...
        public var _emitterType:int;                       // emitterType
        public var _emitterXVariance:Number;               // sourcePositionVariance x
        public var _emitterYVariance:Number;               // sourcePositionVariance y
        public var _defaultDuration:Number;                // duration
        
        // particle configuration
        public var _lifespan:Number;                       // particleLifeSpan
        public var _lifespanVariance:Number;               // particleLifeSpanVariance
        public var _startSize:Number;                      // startParticleSize
        public var _startSizeVariance:Number;              // startParticleSizeVariance
        public var _endSize:Number;                        // finishParticleSize
        public var _endSizeVariance:Number;                // finishParticleSizeVariance
        public var _emitAngle:Number;                      // angle
        public var _emitAngleVariance:Number;              // angleVariance
        public var _startRotation:Number;                  // rotationStart
        public var _startRotationVariance:Number;          // rotationStartVariance
        public var _endRotation:Number;                    // rotationEnd
        public var _endRotationVariance:Number;            // rotationEndVariance
        
        // gravity configuration
        public var _speed:Number;                          // speed
        public var _speedVariance:Number;                  // speedVariance
        public var _gravityX:Number;                       // gravity x
        public var _gravityY:Number;                       // gravity y
        public var _radialAcceleration:Number;             // radialAcceleration
        public var _radialAccelerationVariance:Number;     // radialAccelerationVariance
        public var _tangentialAcceleration:Number;         // tangentialAcceleration
        public var _tangentialAccelerationVariance:Number; // tangentialAccelerationVariance
        
        // radial configuration 
        public var _maxRadius:Number;                      // maxRadius
        public var _maxRadiusVariance:Number;              // maxRadiusVariance
        public var _minRadius:Number;                      // minRadius
        public var _minRadiusVariance:Number;              // minRadiusVariance
        public var _rotatePerSecond:Number;                // rotatePerSecond
        public var _rotatePerSecondVariance:Number;        // rotatePerSecondVariance
        
        // color configuration
        public var _startColor:ColorArgb;                  // startColor
        public var _startColorVariance:ColorArgb;          // startColorVariance
        public var _endColor:ColorArgb;                    // finishColor
        public var _endColorVariance:ColorArgb;            // finishColorVariance
